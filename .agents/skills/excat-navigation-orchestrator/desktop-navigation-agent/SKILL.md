...
Orchestrator will run `node migration-work/navigation-validation/scripts/validate-output.js <output.json> references/desktop-navigation-agent-schema.json`. If validation fails, output is rejected; do not add extra properties or omit required fields.
...
**Functional:** Confirm output validates with `node migration-work/navigation-validation/scripts/validate-output.js <output.json> references/desktop-navigation-agent-schema.json`.
