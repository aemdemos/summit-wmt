...
**Functional:** Confirm output validates with `node migration-work/navigation-validation/scripts/validate-output.js <output.json> references/megamenu-schema.json`.
